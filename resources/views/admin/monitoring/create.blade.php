            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="kondisi_usaha" 
                              ...
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all resize-none">{{ old('kondisi_usaha') }}</textarea>
                    @error('kondisi_usaha')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center">
                            <input type="radio" 
                                   ...
                                   value="baik"
                                   {{ old('perkembangan_usaha') === 'baik' ? 'checked' : '' }}
                                   required
                        ...
                        <label class="flex items-center">
                            <input type="radio" 
                                   name="perkembangan_usaha" 
                                   value="cukup"
                                   {{ old('perkembangan_usaha') === 'cukup' ? 'checked' : '' }}
                                   class="w-4 h-4 text-emerald-600 focus:ring-emerald-500">
                        ...
                        <label class="flex items-center">
                            <input type="radio" 
                                   name="perkembangan_usaha" 
                                   value="kurang"
                                   {{ old('perkembangan_usaha') === 'kurang' ? 'checked' : '' }}
                                   class="w-4 h-4 text-emerald-600 focus:ring-emerald-500">
