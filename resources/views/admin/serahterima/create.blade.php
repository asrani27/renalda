...
@section('title', 'Tambah Serah Terima Bantuan')

@section('page-title', 'Tambah Serah Terima Bantuan')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <form action="{{ route('admin.serahterima.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
