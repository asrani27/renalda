...
@section('title', 'Tambah Data Bantuan')

@section('page-title', 'Tambah Data Bantuan')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="sumber" 
                        ...
                        <option value="APBD" {{ old('sumber') === 'APBD' ? 'selected' : '' }}>APBD</option>
                ...
                <div>
                    ...
                    <textarea id="deskripsi" 
                              ...
                              placeholder="Masukkan deskripsi bantuan (opsional)">{{ old('deskripsi') }}</textarea>
                </div>
