...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.laporan.monitoring.pdf', ['tanggal_mulai' => $tanggalMulai, 'tanggal_selesai' => $tanggalSelesai]) }}" target="_blank"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <p class="text-sm text-gray-600">
                Menampilkan <span class="font-semibold">{{ $monitoring->count() }}</span> data monitoring periode {{ \Carbon\Carbon::parse($tanggalMulai)->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($tanggalSelesai)->format('d/m/Y') }}
            </p>
        </div>
        @endif
    </div>
