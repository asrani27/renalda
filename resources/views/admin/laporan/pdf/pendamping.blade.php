...
<head>
    <meta charset="UTF-8">
    <title>Laporan Data Pendamping</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="judul">
            <h4>LAPORAN DATA PENDAMPING</h4>
        </div>

        <table class="info-table">
            <tr>
                <td width="150">Total Pendamping</td>
                <td>: {{ $totalPendamping }} orang</td>
            </tr>
            <tr>
                <td>Dengan Akun</td>
                <td>: {{ $pendampingDenganAkun }} orang</td>
            </tr>
            @if($search)
            <tr>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->user ? $item->user->username : 'Belum ada' }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="7" style="text-align: center; padding: 20px;">Tidak ada data pendamping</td>
                </tr>
                @endforelse
            </tbody>
        </table>
