        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Nama Penerima</th>
                    <th>Pendamping</th>
                    <th width="200">Kondisi Usaha</th>
                    <th>Perkembangan Usaha</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $i + 1 }}</td>
                    <td>{{ $item->tanggal_monitoring->format('d/m/Y') }}</td>
                    <td>{{ $item->penerima && $item->penerima->calonPenerima ? $item->penerima->calonPenerima->nama :
                        '-' }}</td>
                    <td>{{ $item->pendamping ? $item->pendamping->nama : '-' }}</td>
                    <td>{{ $item->kondisi_usaha }}</td>
                    <td>{{ $item->perkembangan_usaha }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" style="text-align: center; padding: 20px;">Tidak ada data monitoring</td>
                </tr>
                @endforelse
            </tbody>
        </table>
