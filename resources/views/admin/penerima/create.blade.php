    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <form action="{{ route('admin.penerima.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                @enderror
                @if($calonPenerimas->isEmpty())
                    <p class="mt-1 text-sm text-yellow-600">Tidak ada calon penerima yang tersedia. Silakan buat calon penerima baru dengan status valid.</p>
                @endif
            </div>
            ...
            <div class="mb-6">
                ...
                <select name="status_penerima" id="status_penerima" required
                    ...
                    <option value="Proses" {{ old('status_penerima') === 'Proses' ? 'selected' : '' }}>Proses</option>
                    <option value="Disetujui" {{ old('status_penerima') === 'Disetujui' ? 'selected' : '' }}>Disetujui</option>
                    <option value="Ditolak" {{ old('status_penerima') === 'Ditolak' ? 'selected' : '' }}>Ditolak</option>
                </select>
