                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.kriteria.index') }}"
                            class="flex items-center gap-3 px-4 py-3 text-white rounded-lg hover:bg-emerald-700/50 transition-all duration-200 {{ request()->routeIs('admin.kriteria.*') ? 'bg-emerald-700 shadow-lg' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.bobotkelayakan.index') }}"
                            class="flex items-center gap-3 px-4 py-3 text-white rounded-lg hover:bg-emerald-700/50 transition-all duration-200 {{ request()->routeIs('admin.bobotkelayakan.*') ? 'bg-emerald-700 shadow-lg' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z">
                                </path>
                            </svg>
                            <span class="font-medium">Bobot Kelayakan</span>
                        </a>
                    </li>
